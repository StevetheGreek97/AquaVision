...
from segment_anything import sam_model_registry, SamPredictor  # Use SAM 1 imports
import torch
import cv2
...
class SamMasker(QObject):
    ...
    def __init__(self, parent, device='cpu'):
        ...
        sam_model = sam_model_registry["vit_b"](checkpoint="models/meta/sam_vit_b_01ec64.pth")  # Update checkpoint path
    ...
    def generate_mask(self, image):
        """
        Generate a mask using the SAM model based on added points.
